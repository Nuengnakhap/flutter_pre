...
import 'package:flutter_pre_final/UI/photo_screen.dart';
...
class AlbumScreen extends StatelessWidget {
  ...
  AlbumScreen({Key key, @required this.id}) : super(key: key);
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PhotoScreen(albumId: values[index].id),
                  ),
                );
              },
            ),
